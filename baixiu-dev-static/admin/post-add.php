      ...
      <form class="row">
        ...
        <div class="col-md-3">
          ...
          <div class="form-group">
            ...
            <img class="help-block thumbnail" id="preview" style="display: none">
    ...
    $(function () {
           ...
           $('#feature').on('change',function(){
                ...
                $.ajax({
                  ...
                  success:function(res){
                       console.log(res);
                       $('#preview').show().attr('src',res.imgSrc);
